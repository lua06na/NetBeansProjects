...
public class ApiLuanaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            obj.put("RA:", "1290482222027");
            obj.put("NOME:", "LUANA PINHEIRO TEIXEIRA");
            JSONArray arr = new JSONArray();
            list.add("Gestão de Projetos");
            list.add("Estágio Supervisionado em Análise e Desenvolvimento de Sistemas");
            list.add("Banco de Dados");
            list.add("Engenharia de Software III");
            list.add("Programação Orientada a Objetos");
            list.add("Programação para Dispositivos Móveis");
